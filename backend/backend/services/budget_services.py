from backend.queries.budget_queries import get_budgets_by
from backend.queries.transactions_queries import get_category_totals_by
    ...
    return [
        {
            ...
            - budgets_category_totals.get(budget.category.value, 0),
        }
